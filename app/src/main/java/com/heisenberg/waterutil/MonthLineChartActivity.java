...
public class MonthLineChartActivity extends AppCompatActivity{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_month_line_chart);
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction().add(R.id.container1, new PlaceholderFragment()).commit();
        }
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            View rootView = inflater.inflate(R.layout.fragment_month_line_chart, container, false);

            chart = rootView.findViewById(R.id.chart_month);
            previewChart = rootView.findViewById(R.id.chart_preview_month);
        ...
        private void generateDefaultData() {
            ...
            try {
                ...
                HttpPost httpPost = new HttpPost("https://water-util.herokuapp.com/app-monthly");
            ...
            try {
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    values.add(new PointValue(i+1,usage/100));
                }
